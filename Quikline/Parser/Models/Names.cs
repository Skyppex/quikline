...
internal sealed class OptionNameEqualityComparer : IEqualityComparer<Option>
{
    public bool Equals(Option x, Option y) =>
...
internal static class Extensions
{
    ...
    public static Prefix? ToPrefix(this char value) =>
        value is '\0' ? null : new Prefix(value.ToString());
