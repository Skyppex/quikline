...
public static class Quik
{
    ...
    private static void ValidateOption(OptionAttribute? optionAttr, string fieldName)
    {
    ...
    private static void ValidateArgument(ArgumentAttribute? argAttribute, string fieldName)
    {
    ...
    private static void ValidateRest(RestAttribute? restAttribute, string fieldName)
    {
